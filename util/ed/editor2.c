...
void edit_player()
{
	...
	while(1) {
		...
		case 2:			/* level/class/align/stats */
			...
			ply_ptr->alignment = j;
			posit(3,8); getnums(&j, (long)ply_ptr->strength, 0L, 100L);
			ply_ptr->strength = j;
			posit(3,27); getnums(&j, (long)ply_ptr->dexterity, 0L, 100L);
			ply_ptr->dexterity = j;
			posit(3,47); getnums(&j, (long)ply_ptr->constitution, 0L, 100L);
			ply_ptr->constitution = j;
			posit(4,8); getnums(&j, (long)ply_ptr->intelligence, 0L, 100L);
			ply_ptr->intelligence = j;
			posit(4,27); getnums(&j, (long)ply_ptr->piety, 0L, 100L);
			ply_ptr->piety = j;
		...
		case 4:			/* exp/gold/dmg/room */
			...
			posit(2,13); getnums(&j, (long)ply_ptr->experience, 0L, 1000000000L);
		...
		case 5:			/* proficiencies */
			...
			posit(3,3); getnums(&j, (long)ply_ptr->proficiency[0], 0L, 500000000L);
			ply_ptr->proficiency[0] = j;
			posit(3,29); getnums(&j, (long)ply_ptr->proficiency[1], 0L, 500000000L);
			ply_ptr->proficiency[1] = j;
			posit(3,56); getnums(&j, (long)ply_ptr->proficiency[2], 0L, 500000000L);
			ply_ptr->proficiency[2] = j;
			posit(4,3); getnums(&j, (long)ply_ptr->proficiency[3], 0L, 500000000L);
			ply_ptr->proficiency[3] = j;
			posit(4,29); getnums(&j, (long)ply_ptr->proficiency[4], 0L, 500000000L);
			ply_ptr->proficiency[4] = j;
			posit(7,3); getnums(&j, (long)ply_ptr->realm[0], 0L, 500000000L);
			ply_ptr->realm[0] = j;
			posit(7,29); getnums(&j, (long)ply_ptr->realm[1], 0L, 500000000L);
			ply_ptr->realm[1] = j;
			posit(7,56); getnums(&j, (long)ply_ptr->realm[2], 0L, 500000000L);
			ply_ptr->realm[2] = j;
			posit(8,3); getnums(&j, (long)ply_ptr->realm[3], 0L, 500000000L);
			ply_ptr->realm[3] = j;
			break;
		case 6:		   	/* spells */
			clearscreen();
