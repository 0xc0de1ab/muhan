...
#define LOGPATH         MUDHOME"/log" 
 /* 추가 사항 */
#define ALIASPATH	MUDHOME"/player/alias"
#define BANKPATH	MUDHOME"/player/bank"
...
#define CNRM  "0m\x1B[40m\x1B[37m"
#define CRED  "31m"
#define CGRN  "32m"
#define CYEL  "33m"
#define CBLU  "34m"
...
#define SCURSE		56	/* 저주 */
#define SISIX1		57	/* 천상풍 */
#define SISIX2		58	/* 천지진동 */
#define SISIX3		59	/* 천마강기 */
#define SISIX4		60	/* 빙천파 */
#define SRMGONG		61	/* 공포해소 */
#define XIXIX1          62      /* 혈사천 */
#define XIXIX2          63      /* 빙설검 */
#define XIXIX3          64      /* 멸겁화궁 */
#define XIXIX4          65      /* 탄지수통 */     

/* #define SNAHAN          56   */    /* 변수나한권 */

/* 무적 수련을 위해 빌려 사용함. */ 
#define SASSASSIN       100
#define SBARBARIAN      101
#define SCLERIC         102
#define SFIGHTER        103      /* 검사 */
#define SMAGE           104
#define SPALADIN        105
#define SRANGER         106
#define STHIEF          107
#define FROMBRD		108     /* 게시판 */
#define YELLOWI		109	/* 노란초인 빌림*/
#define TRAINBUL	110 	/* 불사로 수련할수 있는 상태*/
...
#define RBANK		39	/* 은행 */
#define RMARRI		40	/* 결혼 */
#define RONMAR          41      /* 결혼한 사람만 갈수 있음 */
#define RCAST           42      /* 주문 전수장 */
#define RDEPOT          43      /* 창고 */      
...
#define PREFLECT        47      /* 반탄강기*/
#define PANGEL          48      /* 정령소환술*/
#define PKNDM1          49      /* Invincible class 3 */
...
#define NOR_SHADOW	6
#define INV_SHADOW	8
#define CAR_SHADOW	10

/* 기술 딜레이 조정 */
#define TECH_FAIL	2
#define BULSA_B		4	
#define CARETAKER_B	3
#define INVINCIBLE_B	2
#define SOLID_B		4
